...
const header = () => {
    return (
        <View style={{ flex: 0.2, alignItems: "center", justifyContent: "center" }}>
            <Text style={{ fontSize: 32, lineHeight: 32, color: "white" }}>Free Courses</Text>
        </View>
    );
};
...
//         <View style={{ flex: 0.2, alignItems: "center", justifyContent: "center" }}>
//             {DATA.map((item) => (
//                 <Text style={{ fontSize: 25, lineHeight: 29, color: "white" }} key={item.id}>
        ...
        {data.sectionsHeading}
            ...
            >
                <View style={{ flex: 1 }}>
                    ...
                    >
                        <Text style={{ color: "#000", fontWeight: "400", padding: 8 }}>{data.topLine}</Text>
                    </View>
                    <TouchableHighlight
                        onPress={() => {
              ...
              1st October 2022•
                ...
                <View style={{ flexDirection: "row", alignItems: "center", padding: 10 }}>
                    ...
                    >
                        <Image style={{ width: 50, height: 50, borderRadius: 25 }} source={{ uri: data.channelLogo }} />
                    </TouchableHighlight>
